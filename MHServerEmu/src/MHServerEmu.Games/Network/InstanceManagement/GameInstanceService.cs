    ...
    public class GameInstanceService : IGameService
    {
        ...
        public void ReceiveServiceMessage<T>(in T message) where T : struct, IGameServiceMessage
        {
            ...
            switch (message)
            {
                ...
                case ServiceMessage.CustomCostumeRegisterRequest customCostumeRegisterRequest:
                    OnCustomCostumeRegisterRequest(customCostumeRegisterRequest);
                    break;
        ...
        private void OnCustomCostumeRegisterRequest(in ServiceMessage.CustomCostumeRegisterRequest request)
        {
            int accepted = CustomCostumeRegistry.Register(request.SessionId, request.ForgedRefs);

            int statusCode = accepted >= 0 ? (int)HttpStatusCode.OK : (int)HttpStatusCode.TooManyRequests;

            ServiceMessage.CustomCostumeRegisterResponse response = new(request.RequestId, statusCode, accepted);
