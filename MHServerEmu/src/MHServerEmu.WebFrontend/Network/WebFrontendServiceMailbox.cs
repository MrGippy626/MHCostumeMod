    ...
    internal sealed class WebFrontendServiceMailbox : ServiceMailbox
    {
        protected override void HandleServiceMessage(IGameServiceMessage message)
        {
            switch (message)
            {
                ...
                case ServiceMessage.CustomCostumeRegisterResponse customCostumeRegisterResponse:
                    GameServiceTaskManager.Instance.OnCustomCostumeRegisterResponse(customCostumeRegisterResponse);
                    break;
