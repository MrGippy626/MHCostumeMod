...
using MHServerEmu.WebFrontend.Handlers.CustomCostumes;
...
namespace MHServerEmu.WebFrontend
{
    ...
    public class WebFrontendService : IGameService
    {
        ...
        public WebFrontendService()
        {
            ...
            _webService.RegisterHandler("/CustomCostumes/Register", new RegisterWebHandler());

            _webService.RegisterHandler("/CustomCostumes/Catalog", new CatalogWebHandler());
